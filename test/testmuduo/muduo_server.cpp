...
epoll+线程池
优点：可以把网络I/O的代码和业务代码区分开
业务感兴趣的方面：暴露  用户的连接和断开  用户的可读写事件
*/
#include <muduo/net/TcpServer.h> //服务器
#include <muduo/net/EventLoop.h> //
#include <iostream>
#include <functional>
#include <string>
using namespace std;
using namespace muduo; // 简化TcpServer命名
...
private:
    ...
    EventLoop *_loop;  // epoll 否则不容易关闭服务器程序
};
int main()
{
    EventLoop loop;
